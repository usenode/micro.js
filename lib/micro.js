...
pkg.define('micro', ['node:http', 'promise', 'fs-promise', 'node:sys', 'node:socket.io'], function (http, promise, fs, sys, io) {
    var ns = {};
    ...
    WebApp.prototype.handleStatic = function (root, prefix) {
        ...
        var realRoot = fs.realpath(root),
            realPaths = {};
        this.handlers.GET.push([new RegExp('^' + prefix + '(.+\\.(css|js|jpe?g|gif|png|swf|spv))$'), function (request, response, path, type) {
            var path = root + path;
